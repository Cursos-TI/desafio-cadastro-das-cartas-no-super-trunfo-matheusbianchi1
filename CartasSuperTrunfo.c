...
int main(){
    // Declaração das variáveis, incluindo densidade populacional e pib per capita
    ...
    // O Problema do nomes de cidades com espaço foi resolvido com fgets
    ...
    // O Problema do nomes de cidades com espaço foi resolvido com fgets
    // getchar para lidar com a sujeira do buffer
    ...
    //Atribuindo valores às novas variáveis depois da entrada dos dados
